        ...
        {
            {
                ...
                for (int i = 0; i < R.Length; i += 8)
                {
                    ...
                    Console.WriteLine("Po" + segmentR[3]);
                    Console.WriteLine("Po" + segmentR[4]);
                    Console.WriteLine("Po" + segmentR[5]);
                    Console.WriteLine("Po" + segmentR[6]);
                    Console.WriteLine("Po" + segmentR[7]);
                }
